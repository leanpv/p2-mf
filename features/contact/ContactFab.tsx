...
export function ContactFab() {
  ...
  return (
    <div className="group/fab fixed bottom-[10px] right-6 md:bottom-8 md:right-8 z-[65]">
      {/* Carta de fondo — aparece al hacer hover */}
      {!onGallery && (
      ...
      <button
        ...
        className={cn(
          "group relative flex items-center gap-2 md:gap-3 px-4 py-3 md:px-6 md:py-4 cursor-pointer overflow-hidden transition-transform duration-300 group-hover/fab:-translate-x-[5px] group-hover/fab:-translate-y-[5px]",
